...
CONFIG = {
    ...
    "max_number_of_clouds": 20,
    "voxel_size": 0.1,
    "print_realtime": True,
    "save_map": True,
    "realtime_people_only": True, # If True, we will only visualize the dynamic objects (people) in the current frame
...
def icp_alignment(csv_files, folder_path, i, input_cloud, static_map, trajectory_global_cloud, person_global_cloud, icp_params, current_transformation, max_count):
    ...
    if i == 0:
        ...
        return predictions, input_cloud_static_downsampled, trajectory_cloud, person_cloud, current_transformation, static_map, trajectory_global_cloud,person_global_cloud1, max_count
    ...
    return predictions, filtered_cloud, trajectory_cloud, person_cloud, current_transformation, static_map, trajectory_global_cloud, person_global_cloud1, max_count
    # # return predictions, {
...
if __name__ == "__main__":
    ...
    # for i in range(0, 50):
        ...
        predictions1, current_static_cloud_aligned1, current_trajectory_aligned1, current_person_aligned1, current_transformation, static_map1, trajectory_global_cloud1, person_global_cloud1, max_count = icp_alignment(csv_files1, folder_path1, i, input_cloud1, static_map1, trajectory_global_cloud1, person_global_cloud1, icp_params, current_transformation, max_count)
        ...
        if CONFIG["realtime_people_only"]:
            show_cloud1 += current_person_aligned1
        else:
